...
Se référer à la [documentation du provider de Terraform pour Hypertec Cloud](https://github.com/cloud-ca/terraform-provider-cloudca/tree/master/doc) pour les derniers attributs.
